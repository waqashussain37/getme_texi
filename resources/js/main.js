!(function (e) {
    ...
    t.on("load", function () {
        var l = e(document),
            ...
            x = e("#slider-range2"),
            S = e("#amount2"),
            D = e("#daterange-single, #daterange-single1, #daterange-single2, #daterange-single3"),
            Y = e("#daterange-single, #daterange-single1, #daterange-single2, #daterange-single3"),
        ...
        t.on("scroll", function () {
            t.scrollTop() >= z ? (document.body.classList.add("fixed-nav")) : ((document.body.style.paddingTop = "0px"), document.body.classList.remove("fixed-nav")),
...
$('.crrnt-currency').current({
    api: 'https://openexchangerates.org/api/latest.json?app_id=5ed2f9bce9b844eb953632ba1e3d4392'
});

$('.select-contain-select').selectpicker({ liveSearch: true, liveSearchPlaceholder: "Search", liveSearchStyle: "contains", size: 5 })
