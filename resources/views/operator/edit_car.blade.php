...
================================= -->
    <section class="listing-form pt-5 pb-5">
        <div class="container">
            ...
            <form action="{{route('operator.edit_car_post', $car->id)}}" method="post" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    <div class="col-lg-12">
                        <div class="form-box">
                            ...
                            <div class="form-content contact-form-action">
                                            ...
                                            <div class="select-contain w-auto">
                                                <select name="type" class="select-contain-select @error('type') is-invalid @enderror" required>
                                                    @foreach($types as $key => $value)
                                                        <option value="{{$key}}" @if($key === $car->type) selected @endif>
                                                            {{$value}}
                                                        </option>
                                                    @endforeach
                                                </select>
                                                ...
                                                <div class="select-contain w-auto">
                                                    <select name="make" class="select-contain-select @error('make') is-invalid @enderror" required>
                                                        @foreach($makes as $make)
                                                            <option value="{{$make->name}}" @if($make->name === $car->make) selected @endif>
                                ...
                                <div class="col-lg-12">
                                    <div class="input-box">
                                        ...
                                        <div class="form-group">
                                            <span class="la la-info form-icon"></span>
                                            <input class="form-control" type="text" name="license_plate"  value="{{$car->license_plate}}" required>
                                        </div>
                                    </div>
                                </div><!-- end col-lg-12 -->
                                <div class="col-lg-12">
                                    <div class="input-box">
                                        ...
                                        <div class="form-group">
                                            <span class="la la-info form-icon"></span>
                                            <input class="form-control" type="number" name="max_passengers" value="{{$car->max_passengers}}" required>
                                        </div>
                                    </div>
                                </div><!-- end col-lg-12 -->
                                <div class="col-lg-12">
                                    <div class="input-box">
                                        ...
                                        <div class="form-group">
                                            <span class="la la-info form-icon"></span>
                                            <input class="form-control" type="number" name="max_luggage" value="{{$car->max_luggage}}" required>
                                        </div>
                                    </div>
                                </div><!-- end col-lg-12 -->
