...
================================= -->
    <section class="listing-form pt-5 pb-5">
        <div class="container">
            ...
            <form action="{{route('operator.edit_driver_post', $driver->id)}}" method="post" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    <div class="col-lg-8">
                        <div class="form-box">
                                ...
                                <div class="col-lg-12">
                                    <div class="input-box">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="text" name="name" value="{{$driver->name}}" required>
                                        </div>
                                    </div>
                                </div><!-- end col-lg-12 -->
                                <div class="col-lg-12">
                                    <div class="input-box">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="text" name="phone_number" value="{{$driver->phone_number}}" required>
                                        </div>
                                    </div>
                                </div><!-- end col-lg-12 -->
