            ...
            <nav aria-label="breadcrumb" class="pb-3">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item" aria-current="page"><a href="{{route('operator.meeting_points')}}">Meeting
                            Points</a></li>
                    <li class="breadcrumb-item active">{{$meetingPoint->title}}</li>
                </ol>
            </nav>
            <form action="{{route('operator.edit_meeting_point_post', $meetingPoint->id)}}" method="post" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    <div class="col-lg-8">
                        <div class="form-box">
                                ...
                                <div class="col-lg-12">
                                    <div class="input-box">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="text" name="title" value="{{$meetingPoint->title}}" required>
                                        </div>
                                    </div>
                                </div><!-- end col-lg-12 -->
                                <div class="col-lg-12">
                                    <div class="input-box">
                                        ...
                                        <div class="form-group">
                                            <span class="la la-info form-icon"></span>
                                            <textarea class="message-control form-control" id="editor" name="description" required>{{$meetingPoint->description}}</textarea>
                                        </div>
                                    </div>
                                </div><!-- end col-lg-12 -->
                                        ...
                                        <div class="select-contain w-auto">
                                            <select name="airport_id" class="select-contain-select @error('airport_id') is-invalid @enderror" required>
                                                @foreach($airports as $airport)
                                                    <option value="{{$airport->id}}" @if($meetingPoint->airport_id === $airport->id) selected @endif>
                        ...
                        <div class="form-box">
                            ...
                            <div class="form-content contact-form-action">
                                <div class="input-box">
                                    ...
                                    <div class="form-group">
                                        <span class="la la-info form-icon"></span>
                                        <input class="form-control" type="text" name="latitude" value="{{$meetingPoint->latitude}}" required>
                                    </div>
                                </div>
                                <div class="input-box">
                                    ...
                                    <div class="form-group">
                                        <span class="la la-info form-icon"></span>
                                        <input class="form-control" type="text" name="longitude" value="{{$meetingPoint->longitude}}" required>
                                    </div>
                                </div>
                            </div><!-- end form-content -->
                        </div><!-- end form-box -->
